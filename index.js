...
/////////////////
const BotName = 'Thurz BOT'; 
const instagram = 'https://instagram.com/62.thurz'; 
const telegram = '-'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/thurz_amv';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@62.thurz')
